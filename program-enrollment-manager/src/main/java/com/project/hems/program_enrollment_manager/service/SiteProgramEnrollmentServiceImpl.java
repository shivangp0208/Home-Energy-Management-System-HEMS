...
public class SiteProgramEnrollmentServiceImpl implements SiteProgramEnrollmentService{
    ...
    public SiteProgramEnrollment enrollSiteinProgram(UUID siteId, @NonNull UUID programId) {
        ...
        try {
            ...
            //because if two thread same time e avse and jose ke site enroll nathi program ma
            //existsBySiteAndProgram with this method so false return karse and banne thread save karse ..
