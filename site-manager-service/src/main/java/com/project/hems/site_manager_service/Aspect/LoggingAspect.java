package com.project.hems.site_manager_service.Aspect;
...
//JoinPoint represnet execution no point
    //* com.project.hems.site_manager_service.service.*.*(..)) this is pointCut expression spseicific aa condition match thay tyare j Advice run thase
//    @Before("execution(* com.project.hems.site_manager_service.service.*.*(..))")//advice kevi padse ke kyare aa ne chalavu che and ene kai method ni pehla chalavu ene PointCut ma kesu
...
//
//
//    @After("execution(* com.project.hems.site_manager_service.service.*.*(..))")
//    public void logAfterMethod(JoinPoint joinPoint){
//        log.info("After method execution {}",joinPoint.getSignature().getName());
//    }

    //around ma manually result return karvu padse
    @Around("execution(* com.project.hems.site_manager_service.service.*.*(..))")
